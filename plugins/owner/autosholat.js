        ...
        for (const jid of groupList) {
          ...
          try {
            const caption =
              ...
              `Sudah saatnya mengistirahatkan sejenak urusan duniamu! Waktu untuk menunaikan ibadah sholat **${sholat}** telah tiba untuk wilayah **${kotaSetting.nama}** dan sekitarnya (tepatnya pada pukul **${waktu} ${TZ_LABEL}**).\n\n` +
