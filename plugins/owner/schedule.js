...
function buildListText(tasks, header = null) {
  ...
  for (const task of sorted) {
    ...
    text += `  ⏰ ${formatClock(task.hour, task.minute)} ${TZ_LABEL}\n`;
...
⏰ Waktu: ${formatClock(task.hour, task.minute)} ${TZ_LABEL}
