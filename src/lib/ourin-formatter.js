...
/**
 * Format nomor telepon ke format yang lebih readable (semua negara)
 * @param {string} number - Nomor telepon
 * @returns {string} Formatted number
 * @example
 * formatNumber('6281234567890'); // '+628 123 456 789 0'
 * formatNumber('22370123456'); // '+223 701 234 56'
 */
 ...
 * @example
 * createArrowLine('Nama', 'Xerophis Bot'); // "│ ➣ Nama: Xerophis Bot"
 */
...
function createBotInfo(data) {
  const {
    botName = config.bot?.name || "Xerophis Bot",
