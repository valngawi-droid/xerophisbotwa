...
import { TIMEZONE, LOCALE } from './xerophis-region.js'

// Zona waktu mengikuti .env BOT_TZ (bawaan Africa/Bamako = Mali).
// Contoh: BOT_TZ=Europe/Moscow (Rusia) | BOT_TZ=Asia/Jakarta (Indonesia)
